				...
				>
					...
					<PopoverGroup className='hidden lg:flex lg:gap-x-12'>
						<Popover className='relative'>
							<PopoverButton className='flex items-center gap-x-1 text-sm/6 font-bold text-white hover:text-[#10b981]'>
								Υπηρεσίες
								<ChevronDownIcon
									aria-hidden='true'
						...
						<Link
							...
							className='text-sm/6 font-bold text-white hover:text-[#10b981]'
						>
							Ο χώρος μας
						</Link>
						<Link
